...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Retail Sales Forecasting Analysis</title>
    </head>
    <body>
        ...
        <div id="main_container">
            ...
            <div id="main_content">
                <form:form commandName="RetailAnalysisWrapper" action="retailsalesforecastinganalysis.htm">
                    ...
                    <div>
                        ...
                        <img SRC="jspchart/${imageName}" WIDTH="100%" HEIGHT="100%" BORDER="0"  USEMAP="#chart"/>
                        <br/><br/><br/><br/>
                    </div>
                </form:form>
